...
//		tim.name = "Tim";
//		allen.name = "Allen";
		bob = Student.createStudent("Bob");
		tim = Student.createStudent("Tim");
		allen = Student.createStudent("Allen");
...
//		math.courseName = "Mathematics";
		bio1 = Section.createSection(1, "Biology");
		bio2 = Section.createSection(2, "Biology");
		math = Section.createSection(3, "Mathematics");
