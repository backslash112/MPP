...
public class Main {
	...
	public static void main(String[] args) {
		Account[] someCheckingAccounts = new CheckingsAccount[2];
		someCheckingAccounts[0] = new CheckingsAccount("231-471", 25.00, 100);
		someCheckingAccounts[1] = new CheckingsAccount("446-973", 25.00, 200);
